#figure(
  table(
    ...
    table.cell(colspan: 2)[
      *Synthèse :* Disposer d'une plateforme, accessible en tout temps et facilement navigable, qui regroupe toutes les informations essentielles liées à la fondation, en particulier les processus, sphères d'autorités et informations sur l'utilisation des outils informatiques.
    ],
    table.cell(colspan: 2)[
      *Objectifs* \
      - Toutes les informations utiles au bon accomplissement de ses rôles sont disponibles.
      - Consultable en tout temps.
      - L'information est structurée de manière à la rendre accessible selon les rôles (filtres).
