#figure(
  table(
    ...
    align: left,
    table.header(
      table.cell(colspan: 2, align: center)[M5 - Cadre d'utilisation des outils numériques (sphère d'autorité)],
    ),
    table.cell(colspan: 2)[
      *Synthèse :* Proposer un cadre et des règles d'utilisation des outils numériques claires, exemplifiées et justifiées. Ce cadre serait en fait l'implémentation de la sphére d'autorité pour les actions en lien avec les IT que des collaborateurs mênent.
    ],
    table.cell(colspan: 2)[
      *Objectifs* \
