...
La méthode utilisée par ce travail se base essentiellement sur les 6 entretiens menés ainsi que l'atelier d'évaluation. Bien que les rôles interviewés soient larges, l'analyse est donc en partie basée sur la vision de ces personnes et ne représente pas donc l'avis complet des collaborateurs. Pour appuyer davantage les réflexions et bénéficier d'une meilleure acceptation de l'ensemble de la Fondation, il serait intéressant de procéder à des sondages quantitatifs pour recueillir plus de données ou d'offrir une occasion d'effectuer des retours à l'ensemble des collaborateurs.
