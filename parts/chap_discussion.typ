...
Les différents points relevés lors des entretiens correspondent bien aux potentielles contraintes que la revue de littérature soulevait pour ce type de gouvernance. Les éléments plus concrets relevés en entretiens semblent aussi bien s'aligner avec les défis de coordination et communication que peuvent rencontrer les équipes dans une gouvernance distribuée.

Comme cela a été exploré au @chap-analyse-gouvernance-jobtrek, la fondation met déjà en œuvre une série d'outils et processus pour le bon fonctionnement de sa gouvernance. Notamment l'application Peerdom ou les différentes réunions par cercles et rôles spécifiques. Actuellement, le travail en équipe et l'accomplissement de la mission des différents cercles de la fondation semblent apporter satisfaction. La gouvernance distribuée répond donc bien à ses objectifs pour le fonctionnement courant des cercles. Cela correspond aussi bien aux apports promis par un système de gouvernance distribuée, voir @chap-revue-nouveaux-modeles-entreprises.

Cependant, il semble que les lacunes de la gouvernance apparaissent lorsque les processus, le cadre ou les séances mise en place ne couvrent pas certains cas. En particulier lorsque des cercles transversaux doivent être impliqués -- dont le cercle IT. Le cadre et les processus semblent clairs pour le fonctionnement courant des rôles dans leurs cercles, il ne semble pas l'être lorsque d'autres cercles transversaux doivent intervenir au sein des cercles.
...
- Il pourrait être intéressant de travailler en parallèle sur les deux niveaux de mesures proposés en fin du chapitre précédent. En particulier car elles font intervenir des personnes différentes dans leur mise en place, ce qui permet potentiellement une meilleure charge de travail.
...
#figure(
  table(
    ...
    table.cell(
      colspan: 2,
    )[*#link(<mesure-M3>, "M3") et #link(<mesure-M4>, "M4") Base de connaissances et plateforme de formation :* _il pourrait être étudié d'implémenter ces deux mesures avec un outil pour mutualiser les ressources simplifier l'accès. Leur présence permettrait à terme de communiquer et former plus efficacement aux changements et nouveautés. Une fois mis en place, cela pourrait permettre la mise en place de la mesure #link(<mesure-M12>, "M12") (Onboarding plus complet) en utilisant ces nouveaux outils._],
    [*2*],
...
Les blocs deux et trois du @table-strategie-mise-en-place sont plus conséquents et nécessiteraient un travail de recherche et de récolte des avis pour être mis en place de manière consensuelle avec touts les membres de la Fondation.
...
La méthode utilisée par ce travail se base essentiellement sur les six entretiens menés ainsi que l'atelier d'évaluation. Bien que les rôles interviewés soient larges, l'analyse est donc en partie basée sur la vision de ces personnes et ne représente pas donc l'avis complet des collaborateurs. Pour appuyer davantage les réflexions et bénéficier d'une meilleure acceptation de l'ensemble de la Fondation, il serait intéressant de procéder à des sondages quantitatifs pour recueillir plus de données ou d'offrir une occasion d'effectuer des retours à l'ensemble des collaborateurs.

Il serait aussi intéressant d'effectuer un travail similaire dans d'autres structures de même taille, avec et sans gouvernance distribuée. Cela permettrait d'obtenir des points de comparaisons qui permettraient de mieux situer les mesures proposées. Sont elles applicables à d'autres entreprises ? Fonctionnent elles uniquement pour des structures distribuées ou ont-elles aussi un apport dans des structures plus classiques ? Un travail de recherche à plus large échelle permettrait de s'affranchir du prisme de Jobtrek et de proposer des mesures ou principes plus généraux, a la manière des propositions explorées lors de la revue de littérature, mais spécifique à la problématique explorée par ce travail.
