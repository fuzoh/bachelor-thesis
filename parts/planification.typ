...
#timeliney.timeline(show-grid: true, heading-spacing: 8pt, {
  import timeliney: *
  ...
  milestone(at: 0.2, style: (stroke: (dash: "dashed")), align(center, [
    *Début du travail*\
    1er avril 2025
  ]))

  milestone(at: 15.8, style: (stroke: (dash: "dashed")), align(right, [
    *Rendu du travail*\
    20 juillet 2025
  ]))
})
