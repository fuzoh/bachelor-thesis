...
La complexité des processus et des systèmes informatiques qui vont avec une gouvernance distribuée peut potentiellement nécessiter des compétences et ressources plus avancées que dans le cadre de structures plus hiérarchisées et ou la multiplicité des rôles et moindre. Des défis de formation et de transmission des compétences IT auprès des collaborateurs peuvent alors apparaitre @how-Mercedes-addresses-digital-transformation-using-holacracy-ackermann.
